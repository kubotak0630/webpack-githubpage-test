...
/* harmony import */ var _css_style_css__WEBPACK_IMPORTED_MODULE_209__ = __webpack_require__(/*! ./css/style.css */ "./src/css/style.css");
/* harmony import */ var _css_style_css__WEBPACK_IMPORTED_MODULE_209___default = /*#__PURE__*/__webpack_require__.n(_css_style_css__WEBPACK_IMPORTED_MODULE_209__);
/* harmony import */ var _src_ext_js__WEBPACK_IMPORTED_MODULE_210__ = __webpack_require__(/*! ./src_ext.js */ "./src/src_ext.js");
 ...
 //css-loaderとstyle-loaderがloaderで適用される



var axios = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");

var elem1 = document.querySelector('#hoge1');
var a = 10;
elem1.innerHTML = "export_default: ".concat(_src_ext_js__WEBPACK_IMPORTED_MODULE_210__["default"].val1);
var json_data = {}; //jsonデータの読み込み
//axios.get('./test.json')

axios.get('https://github.com/kubotak0630/data_json/blob/master/test.json').then(function (response) {
  json_data = response.data;
  console.log('------axios------');
  console.log(json_data);
  var elem2 = document.querySelector('#hoge2');
  elem2.innerHTML = "axios_get a: ".concat(json_data.a, ", b: ").concat(json_data.b, " ");
...
/* harmony default export */ __webpack_exports__["default"] = (hoge_const);
